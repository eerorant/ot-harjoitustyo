...
//
//                buttonsA[row][column].setOnMouseClicked((event) -> {
...
//                
//
//                buttonsB[row][column].setOnMouseClicked((event) -> {
//                    if (event.getButton() == MouseButton.SECONDARY) {
...
//
//                
//                setUpGrid1.add(buttonsA[row][column], column, row);
//                setUpGrid2.add(buttonsB[row][column], column, row);
//            }
//        }
//
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                ...
                if (boardA.getShipSquares() >= 15) {
                    buttonsA[i][j].setStyle("-fx-background-color: #b5b5b5; ");
                }
            }
        }    
    }
